  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        {
            path: "/system/resourcesList",
            name: "role",
            component: () => import("@/views/system/resourcesList.vue")
        },
        {//物资出门记录
            path: "/record/outList",
            name: "outList",
            component: () => import("@/views/record/outList.vue")
        },
        {//游客出入门系统
            path: "/record/inList",
            name: "inList",
            component: () => import("@/views/record/inList.vue")
        }
    ]
  }
];
